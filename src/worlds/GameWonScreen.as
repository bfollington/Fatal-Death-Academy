package worlds
{
	...
	public class GameWonScreen extends WorldBase
	{
		
		private var _logo:Entity;
		private var _bg1:Entity, _bg2:Entity;
		
		public function GameWonScreen(soundController:SoundController)
		{
			super();
		...
		override public function begin():void
		{
			...
			_logo = addGraphic(new Image(IMG.WIN_IMAGE), 0, 320 / 2 - 288 / 2, -200);

			var titleTween:VarTween = new VarTween();
			titleTween.tween(_logo, "y", 50, 80, Ease.bounceOut);
			addTween(titleTween, true);
			
			createTextWithShadow("Press space to go back to the title!", 0, 200, 16, true);
		}
		...
		override public function update():void
		{
			...
			{
				sndCtrl.play_title_track();
				FP.world = new TitleScreen(true, sndCtrl);
			}
		}
	}
}